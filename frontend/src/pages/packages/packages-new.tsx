...
import { create } from '../../stores/packages/packagesSlice';
...
PackagesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_PACKAGES'}>
      {page}
    </LayoutAuthenticated>
  );
};
