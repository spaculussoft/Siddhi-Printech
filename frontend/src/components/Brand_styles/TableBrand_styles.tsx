...
import { loadColumns } from './configureBrand_stylesCols';
...
const TableSampleBrand_styles = ({
  ...
  const {
    ...
    loading,
    count,
    notify: brand_stylesNotify,
    refetch,
  } = useAppSelector((state) => state.brand_styles);
  ...
  useEffect(() => {
    if (brand_stylesNotify.showNotification) {
      notify(
        brand_stylesNotify.typeNotification,
        brand_stylesNotify.textNotification,
      );
    }
  }, [brand_stylesNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/brand_styles/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/brand_styles/brand_styles-view/?id=${id}`);
  };
...
export default TableSampleBrand_styles;
