...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/packages/packagesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePackagesCols';
...
const TableSamplePackages = ({
  ...
  useEffect(() => {
    if (packagesNotify.showNotification) {
      notify(packagesNotify.typeNotification, packagesNotify.textNotification);
    }
  }, [packagesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/packages/packages-view/?id=${id}`);
  };
...
export default TableSamplePackages;
