...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/industries/industriesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureIndustriesCols';
...
const TableSampleIndustries = ({
  ...
  useEffect(() => {
    if (industriesNotify.showNotification) {
      notify(
        industriesNotify.typeNotification,
        industriesNotify.textNotification,
      );
    }
  }, [industriesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/industries/industries-view/?id=${id}`);
  };
...
export default TableSampleIndustries;
